...
class Solution {
    ...
    private ListNode addTwoNumgbersRecursive(ListNode l1, ListNode l2, int carry) {
        if (l1 == null && l2 == null && carry == 0) {
            return null;
        }
    ...
    private ListNode addTwoNumbersRecdursives(ListNode l1, ListNode l2, int carry) {
        if (l1 == null && l2 == null && carry == 0) {
            return null;
        }
    ...
    private ListNode addTwoNumbersrrRecursives(ListNode l1, ListNode l2, int carry) {
        if (l1 == null && l2 == null && carry == 0) {
            return null;
        }
